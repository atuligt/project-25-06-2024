    ...
    <div className="hero bg-[#2B1634] py-[100px] px-4">
        <div className="inner_hero max-w-[1247px] 2xl:max-w-[1547px] m-auto">
            <div className="max-w-[577px]">
                ...
                <p className="text-white font-black	font-railway">STRATEGIC ECOMMERCE AND DIGITAL AGENCY</p>
                <p className="text-[#3BBA9C] font-bold mt-[25px] font-railway">ACHIEVE YOUR GOAL WITHOUT GIVING UP</p>
            </div>
        </div>
    </div>
  )
